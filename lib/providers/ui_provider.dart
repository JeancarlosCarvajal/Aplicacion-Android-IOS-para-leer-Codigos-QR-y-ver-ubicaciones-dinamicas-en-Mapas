...
class UiProvider extends ChangeNotifier { 
  // UiProvider extendemos de changeNotifier del paquete de material para que se tenga acceso a esata herramienta y notificar cambios en el valor de _selectedMenuOpt
